...
//        10'd303: lut_data <= {8'h78 , 24'h321203};
//        10'd304: lut_data <= {8'h78 , 24'h380806}; 
//        10'd305: lut_data <= {8'h78 , 24'h380940};
//        10'd306: lut_data <= {8'h78 , 24'h380a04};
//        10'd307: lut_data <= {8'h78 , 24'h380bb0}; 
//        10'd308: lut_data <= {8'h78 , 24'h381000};
//        10'd309: lut_data <= {8'h78 , 24'h381110};
//        10'd310: lut_data <= {8'h78 , 24'h381200}; 
//        10'd311: lut_data <= {8'h78 , 24'h381304};
//        10'd312: lut_data <= {8'h78 , 24'h380a04};
//        10'd313: lut_data <= {8'h78 , 24'h321213}; 
//        10'd314: lut_data <= {8'h78 , 24'h3212a3};          
